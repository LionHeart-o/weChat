...
import static com.example.wechat.methods.getMysql.getContacts;
import static com.example.wechat.methods.getMysql.login;
import static com.example.wechat.methods.getMysql.register;
...
public class DBThread implements Runnable {
    ...
    @Override
    public void run() {
        if(action.equals("注册")) register(email,password,user_name,context);
        else if(action.equals("登录")) login(email,password,loginBean,context);
        else if(action.equals("获取联系人")) getContacts(email,loginBean,pythonList,context);
        ...
        else if(action.equals("添加好友")) addContact(email,contactEmail);
